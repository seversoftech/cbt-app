...
<div class="container" style="display: flex; justify-content: center; min-height: 100vh; align-items: center;">
    <div class="card" style="width: 100%; max-width: 800px;">
        <h1 class="text-center" style="margin-bottom: 2rem;">Welcome to Seversoft CBT</h1>
        
        <div id="startScreen" style="display: block;">
            <div id="categoryScreen">
                <p id="welcomeMsg" class="text-center">Select a subject to begin the 30-minute test.</p>
                
                <div id="categoryList" style="display: none;">
                    <div class="form-group">
                        <label for="categorySelect">Select Subject</label>
                        <select id="categorySelect" class="form-control">
                            <option value="">Loading subjects...</option>
                        </select>
                    </div>
                    <button id="startBtn" class="btn" style="margin-top: 1.5rem; width: 100%;">Start Test</button>
                </div>
            </div>

            <div id="resumePrompt" style="display: none; background: #eef2ff; padding: 1.5rem; border-radius: 0.75rem; border: 1px solid #c7d2fe;">
                <p style="margin-bottom: 1rem;">A <strong id="resumeCategory"></strong> test is in progress. Do you want to <strong>resume</strong> from Question <span id="resumeQ"></span>?</p>
...
<div id="infoModal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button id="acknowledgeBtn" class="btn" onclick="closeInfoModal()">I Understand - Proceed</button>
        </div>
    </div>
</div>
